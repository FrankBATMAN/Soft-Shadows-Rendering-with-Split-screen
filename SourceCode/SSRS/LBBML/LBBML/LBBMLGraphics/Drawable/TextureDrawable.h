...
class LBBML_GRAPHICS_DLL_EXPORTS CLBBMLGraphicsTextureDrawable: public CLBBMLGraphicsDrawableBase
{
public:
	CLBBMLGraphicsTextureDrawable(void);
	virtual ~CLBBMLGraphicsTextureDrawable(void);
